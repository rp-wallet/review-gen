  ...
  return (
    ...
    >
      ...
      <div className='flex-1'>
        <button
          className="liquid-glass flex items-center justify-center size-[40px] rounded-full outline-none cursor-pointer relative text-white transition-transform duration-200 active:scale-95 shrink-0"
        >
      ...
      <div className='flex-1 flex justify-end'>
        <button
          className="liquid-glass flex items-center justify-center size-[40px] rounded-full shrink-0 transition-transform duration-200 active:scale-95"
        >
          {/* Topic icon */}
