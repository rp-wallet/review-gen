...
export default function ChatCanvas({ review }: { review?: ReviewSet | null }) {
  if (review) {
    return <GeneratedChatCanvas review={review} />;
  }

  return (
    <div className="flex flex-col h-[50vh]  max-w-[430px] mx-auto relative overflow-hidden chat-bg">
