            ...
            <div className="flex flex-col gap-4">
              ...
              <Card>
                ...
                <CardContent className="flex flex-col gap-2 pt-4">
                  <Separator />
                  <Label htmlFor="status-time">Time</Label>
                  <Input
                    id="status-time"
                    className="text-center font-mono text-[13px]"
                    value={statusBarTime}
              ...
              {!selected && (
                <Button
                  ...
                  className="w-full border-red-200/15 bg-red-500 text-red-50 shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_8px_22px_-14px_rgba(255,80,80,0.8)] hover:bg-red-500/24 hover:text-white"
                >
                  <RotateCcw size={15} />
                  Clear Conversation
                </Button>
